            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="class_left">
                  ...
                  <h3 style={{ fontFamily: 'Times New Roman' }}>History</h3><br />
                  ...
                  <ul className="property_sec">
                    <li>
                      <div className="rec_proprty">
                        <div className="propertyImg"><img src="images/gallery-1.jpg" alt="" /></div>
                    ...
                    <li>
                      <div className="rec_proprty">
                        <div className="propertyImg"><img src="images/gallery-2.jpg" alt="" /></div>
                        <div className="property_info">
                          <h4><a href="#">English Classroom</a></h4>
                          <p>Lorem ipsum dolor sit amet, adipiscing elit.</p>
                        </div>
                    ...
                    <li>
                      <div className="rec_proprty">
                        <div className="propertyImg"><img src="images/gallery-3.jpg" alt="" /></div>
                        <div className="property_info">
                          <h4><a href="#">English Classroom</a></h4>
                          <p>Lorem ipsum dolor sit amet, adipiscing elit.</p>
                        </div>
